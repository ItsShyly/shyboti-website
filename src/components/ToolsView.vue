...
<style scoped>
.tools-view { display: flex; flex-wrap: wrap; gap: 20px; align-content: flex-start; }
...
.obsconn-icon { color: #9d6cff; }

.obsconn-locked-hint { font-size: 10px; color: #444; padding: 0 18px 14px; }
