...
<template>
  <div class="images-page">
    ...
    <div v-if="view === 'gallery'" class="gallery-view">
      ...
      <div v-if="galleryLoad" class="gallery-empty">{{ t('images.loading') }}</div>
      <div v-else-if="!images.length" class="gallery-empty">{{ t('images.empty') }}</div>
...
.dropzone {
  ...
  background: #111217; border: 2px dashed #2a2a30;
...
.link-bar {
  ...
  padding: 8px 12px; width: min(500px, 90vw);
}
.link-label { font-size: 10px; font-weight: 700; color: #555; text-transform: uppercase; letter-spacing: .05em; flex-shrink: 0; }
.link-code  { flex: 1; font-family: 'Consolas','Fira Mono',monospace; font-size: 12px; color: #9d6cff; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.copy-btn {
  height: 28px; padding: 0 12px; border: 1px solid #6f2bff55;
...
.your-btn {
  ...
  background: transparent; color: #888; font-family: inherit; font-size: 12px;
...
.gallery-title { font-size: 16px; font-weight: 700; color: #e0e0e0; flex: 1; }
.gallery-count { font-size: 11px; color: #555; }
.gallery-empty { color: #444; font-size: 13px; padding: 40px; text-align: center; }
...
.gallery-item-info { padding: 8px 10px; display: flex; flex-direction: column; gap: 3px; flex: 1; }
.gallery-item-name { font-size: 12px; color: #ccc; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.gallery-item-meta { font-size: 10px; color: #444; }
.gallery-item-link { display: flex; align-items: center; gap: 5px; margin-top: 2px; }
.img-link-code { font-family: 'Consolas','Fira Mono',monospace; font-size: 10px; color: #9d6cff; flex: 1; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; }
.copy-btn-sm {
...
.delete-btn {
  ...
  width: 22px; height: 22px; border: 1px solid #f1494944;
  background: #0d0d10cc; color: #f14949; font-size: 11px;
