  ...
  <div class="more-view">
    ...
    <div class="service-card" @click="router.push('/images')">
      ...
      <div class="card-icon images-icon">
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <!-- Mountain -->
          <path
            d="M4 32L14 20L22 28L30 18L44 32"
            stroke="currentColor"
            stroke-width="2.5"
          ...
          <path
            d="M38 15.5V9M35.5 11.5L38 9L40.5 11.5"
            stroke="white"
            stroke-width="1.8"
            stroke-linecap="round"
            stroke-linejoin="round"
    ...
    <div class="service-card" @click="router.push('/notes')">
      ...
      <div class="card-icon notes-icon">
        <svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path
            d="M38 41V35M35.5 37.5L38 35L40.5 37.5"
            stroke="white"
            stroke-width="1.8"
            stroke-linecap="round"
            stroke-linejoin="round"
      ...
      <button
        class="your-btn notes-btn"
        @click.stop="router.push('/notes?list=1')"
      >
        <svg viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
            d="M1 3.5h12M1 7h12M1 10.5h8"
            stroke="currentColor"
            stroke-width="1.4"
            stroke-linecap="round"
          />
    ...
    >
      ...
      <div class="card-body">
        ...
        <div class="card-url">
          obs.shyboti.de/<span class="url-id obs-id">id</span>
        </div>
      </div>
      <button
        class="your-btn obs-btn"
        @click.stop="router.push('/obs-widgets')"
      >
        <svg viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect
            x="1"
      ...
      <div class="vars-modal">
        ...
        <div class="vars-body">
          ...
          <table v-else-if="varsTab === 'counters'" class="vars-table">
            ...
            <tbody>
              <tr v-if="!counters.length">
                <td colspan="3" class="vars-empty">No counters yet</td>
              </tr>
              <tr v-for="c in counters" :key="c.name">
                ...
                <td>
                  <template v-if="editingKey === 'counter:' + c.name + ':'">
                    ...
                    <button class="vars-btn" @click="editingKey = ''">
                      Cancel
                    </button>
                  </template>
          ...
          <table v-else-if="varsTab === 'vars'" class="vars-table">
            ...
            <tbody>
              <tr v-if="!vars.length">
                <td colspan="3" class="vars-empty">No vars yet</td>
              </tr>
          ...
          <table v-else-if="varsTab === 'ucounters'" class="vars-table">
            ...
            <tbody>
              <tr v-if="!ucounters.length">
                <td colspan="4" class="vars-empty">No user counters yet</td>
              </tr>
          ...
          <table v-else-if="varsTab === 'uvars'" class="vars-table">
            ...
            <tbody>
              <tr v-if="!uvars.length">
                <td colspan="4" class="vars-empty">No user vars yet</td>
              </tr>
        ...
        <div class="vars-footer">
          ...
          <div v-else class="vars-add-form">
            ...
            <input
              ...
              :placeholder="addingType.includes('counter') ? '0' : 'value'"
              style="width: 100px"
            />
            <input
      ...
      <div class="modal">
        ...
        <div class="modal-body">
          <div class="mc-row">
            ...
            <button
              class="mc-copy"
              @click="copyText('https://shyboti.de/api/images/upload', 'url')"
            >
              {{ copied === "url" ? "✓" : "copy" }}
            </button>
          </div>
          ...
          <div class="mc-row">
            ...
            <button
              class="mc-copy"
              @click="copyText('https://i.shyboti.de/{id}', 'link')"
            >
              {{ copied === "link" ? "✓" : "copy" }}
            </button>
          </div>
          ...
          <div class="mc-row">
            <span class="mc-label"
              >Extra headers <span class="mc-optional">optional</span></span
            >
            <code v-if="!session" class="mc-val mc-muted">Log in to see</code>
            <code v-else-if="tokenLoading" class="mc-val mc-muted"
              >Generating…</code
            >
