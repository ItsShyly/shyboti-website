...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "cp.field.category_gate": "Category gate",
    "cp.field.category_gate_hint": "Automatically enable/disable this reward based on the live category",
    "cp.cost": "Cost",
    "cp.enabled": "Enabled",
    "cp.edit": "Edit",
  ...
  de: {
    ...
    "cp.field.category_gate": "Kategorie-Kopplung",
    "cp.field.category_gate_hint": "Aktiviert/deaktiviert diese Belohnung automatisch je nach aktueller Kategorie",
    "cp.cost": "Kosten",
