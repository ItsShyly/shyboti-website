...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "trigger.field.gate_mode": "On change",
    "trigger.gate.none": "Just fire the action",
    "trigger.gate.enable_on_change": "Enable on change",
    "trigger.gate.disable_on_change": "Disable on change",
    "trigger.gate.enable_while_active": "Enable only while active",
    "trigger.gate.disable_while_active": "Disable only while active",
    "trigger.gate.hint": "This mode turns the trigger itself on/off - it doesn't run an action.",
  ...
  de: {
    ...
    "trigger.field.gate_mode": "Bei Änderung",
    "trigger.gate.none": "Aktion ausführen",
    "trigger.gate.enable_on_change": "Bei Änderung aktivieren",
    "trigger.gate.disable_on_change": "Bei Änderung deaktivieren",
    "trigger.gate.enable_while_active": "Nur aktiv, solange zutreffend",
    "trigger.gate.disable_while_active": "Nur deaktiviert, solange zutreffend",
    "trigger.gate.hint": "Dieser Modus schaltet den Trigger selbst an/aus - er führt keine Aktion aus.",
    "trigger.field.command": "Command",
