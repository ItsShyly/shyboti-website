...
const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "cmddesc.prefix": "Shows or sets the command prefix (setting is mods/broadcaster only).",
  ...
  de: {
    ...
    "cmddesc.prefix": "Zeigt oder setzt das Command-Prefix (Setzen nur für Mods/Broadcaster).",
